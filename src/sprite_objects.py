...
class Sprites:
    def __init__(self):
        self.sprite_parameters = {
            ...
            'sprite_rock': {
                'sprite': pygame.image.load('sprites/rock/rock2.png').convert_alpha(),
                'viewing_angles': None,
                'shift': 0.9,
                'scale': (0.6, 0.6),
                'side': 30,
        ...
        self.list_of_objects = [
            ...
            # SpriteObject(self.sprite_parameters['sprite_rock'], (8.7, 2.5)),
            # SpriteObject(self.sprite_parameters['npc_devil'], (7, 4)),
            # SpriteObject(self.sprite_parameters['npc_devil'], (8, 1)),
